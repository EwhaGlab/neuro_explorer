...
class covrew_data_visualizer():
    ...
    def viz_data_generator(self, widx, num_rounds, data_augment=False):
        round_idxs = np.arange(num_rounds)

        for roundidx in round_idxs:  # 99):
            ...
            for ii in data_idxs:  # range(0, num_data):
                ...
                gt_img = gt_rewmap_tform
                if data_augment:
                    input_img, gt_img = rotate(input_img, gt_img)
